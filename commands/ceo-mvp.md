...
Guide building a minimum viable product the minimalist entrepreneur way - manual first, then processized, then productized. Use when ready to build your first product or struggling with scope.
...
- [ ] Set up payments (Stripe or Square - 2.9% + 30c per transaction)
